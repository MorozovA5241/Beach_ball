...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(Main main) {
        ...
        rightButton = new ButtonView(20, 100, 100, 100, OBJECT_IMG_PATH);
        jumpButton = new ButtonView(1100, 100, 100, 100, OBJECT_IMG_PATH);
        leftButton = new ButtonView(140, 100, 100, 100, OBJECT_IMG_PATH);
        wall = new StaticGameObject(SCREEN_WIDTH/2, 30, 20, 600, main.world, OBJECT_IMG_PATH, SIMPLE_BIT);
        ball = new GameObject(SCREEN_WIDTH/2 - 100, 600, 100, 100, main.world, BALL_IMAGE_PATH, BALL_BIT, 1.5f, 1.5f, 1.4f);
        topSideWall = new StaticGameObject(SCREEN_WIDTH / 2, SCREEN_HEIGHT, 3000, 80, main.world, OBJECT_IMG_PATH, SIMPLE_BIT); //под вопросом
        rightSideWall = new StaticGameObject(0, SCREEN_HEIGHT / 2, 3, 1500, main.world, OBJECT_IMG_PATH, SIMPLE_BIT);
        leftSideWall = new StaticGameObject(SCREEN_WIDTH, SCREEN_HEIGHT / 2, 3, 1500, main.world, OBJECT_IMG_PATH, SIMPLE_BIT);
    ...
    public void render(float delta) {
        ...
        if(ball.needSetPosition == true){  // жесточайший костыль для телепортации мячика убиваем старый и создаем другой
            ...
            ball = new GameObject(SCREEN_WIDTH/2 - 100, 500, 100, 100, main.world, BALL_IMAGE_PATH, BALL_BIT, 1.5f, 1.5f, 1.4f);
        }
